...
const HomeCard = ({
    imageSrc, price, rating, title, features
}: HomeCardProps) => {
    return (
        <Link to="/offers/1">
            <div className="group bg-white rounded-3xl overflow-hidden border border-slate-100 hover:border-primary/20 hover:shadow-2xl hover:shadow-primary/5 transition-all cursor-pointer">
                <div className="relative h-72 overflow-hidden">
                    <img alt="Room" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" src={imageSrc} />
