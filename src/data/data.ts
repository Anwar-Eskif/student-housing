...
const MY_BOOKINGS_TEXT = {
    title: 'حجوزاتي',
    loading: 'جاري التحميل...',
    error: 'حدث خطأ أثناء جلب الحجوزات'
};

const MY_BOOKING_CARD_TEXT = {
    price_label: 'السعر',
    visit_date_label: 'تاريخ الزيارة',
    visit_time_label: 'وقت الزيارة',
    status: {
...
export { NAV_LINKS, AUTH_TEXT, ERROR_MESSAGES, OFFERS_DATA , HOME_CARD_DATA, FEATURED_OFFERS_TEXT, HERO_SECTION_TEXT, HOME_CARD_TEXT, SEARCH_INPUT_TEXT, BOOKING_CARD_TEXT, BOOKING_CONFIRMATION_POPUP_TEXT, BOOKING_REQUEST_POPUP_TEXT, LANDLORD_PROFILE_CARD_TEXT, OFFER_DETAILS_DATA, OFFER_DETAILS_TEXT, REVIEW_POPUP_TEXT, FILTER_SIDEBAR_TEXT, OFFERS_PAGE_TEXT, OFFER_CARD_TEXT, MY_BOOKINGS_TEXT, MY_BOOKING_CARD_TEXT }